...
export function ProjectModal({ project, isOpen, onClose }: ProjectModalProps) {
  ...
  const odaDetails = {
    description: "Este objeto digital de aprendizagem foi desenvolvido para trabalhar de forma lúdica e interativa com os estudantes dos anos iniciais, promovendo o desenvolvimento de competências essenciais alinhadas à BNCC.",
    lastUpdate: "15 de Outubro, 2024",
    views: 1847,
    rating: 4.8,
    learningObjectives: [
          ...
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 overflow-hidden">
            ...
            <div className="flex flex-col bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-8 overflow-y-auto">
              ...
              <div className="flex flex-wrap items-center gap-3 mb-6">
                ...
                {project.livro && (
                  <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-100/90 to-indigo-100/90 backdrop-blur-sm border-2 border-blue-300 rounded-full shadow-md">
                    ...
                    <span className="font-bold text-sm text-blue-900">{project.livro}</span>
                  </div>
                )}
                {project.pagina && (
              ...
              <div className="flex flex-col gap-3 mt-auto pt-4">
                <button className="w-full bg-gradient-to-r from-primary via-purple-600 to-pink-600 px-6 py-3.5 rounded-full text-white hover:shadow-2xl hover:shadow-primary/40 transition-all flex items-center justify-center gap-2 font-bold">
                  <ExternalLink className="w-5 h-5" />
                  <span>Visualizar ODA Completo</span>
                </button>
            ...
            <div className="flex flex-col bg-white p-8 overflow-y-auto">
              ...
              <div className="space-y-3 p-5 bg-gradient-to-br from-primary/5 to-purple-50 rounded-xl border-2 border-primary/20 mb-6">
                ...
                <p className="text-xs text-muted-foreground pt-3 border-t border-primary/20">
